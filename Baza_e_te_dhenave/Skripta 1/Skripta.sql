...
--1. Add column Discount on table Products
Alter table Products
add Discount char(20) 


--2. Change the color where specified product is nutribullet
Update Products
set color='no specific color'
where ProductName='nutribullet'



--3. Delete row ExpireDate from Table CreditCard
Delete from CreditCard where ExpireDate='01/20';
